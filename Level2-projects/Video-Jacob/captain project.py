...
backMario = load_img("tilted background.JPG") # Background image file
my_video.set_back('back1', backMario)       # Save it in the video
my_video.show_back('back1')                 # Show it


# Add a SECOND BACKGROUND 
img = load_img("tilted background.JPG") # Background image file
...
my_2nd_sprite.set_sprite("ghoul trooper.png") # Load it from the file B1.pickle
my_2nd_sprite.show("")       # Show it


##############################################################

# Make the FIRST sprite available to your video:
my_sprite_name_1 = "SuperMario"
