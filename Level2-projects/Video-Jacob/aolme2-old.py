...
class TSP:   
    ...
    def plot_tour(self, tour, num_of_rows, num_of_cols):
        ...
        radius_value = 0.01*(col_max-col_min)
        offset = 2*radius_value        
        ...
        for i in range(0, len(tour)-1, 1):            
            ...
            circle1=plt.Circle(c1, radius=radius_value, color='r', fill=False)
            circle2=plt.Circle(c2, radius=radius_value, color='r', fill=False)                      
