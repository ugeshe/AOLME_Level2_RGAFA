...
row_center    = 400
column_center = 100
my_video.scale_sprite(my_sprite_name_2, row_center, column_center,0.3)
...
row_center    = 300
column_center = 200
my_video.scale_sprite(my_sprite_name_2, row_center, column_center,0.5)

# Place the FIRST SPRITE
row_center    = 140
column_center = 500
my_video.scale_sprite(my_sprite_name_1, row_center, column_center,1)
...
my_video.scale_sprite("SuperMario", row_bowser, col_bowser,1.5)
...
# Move a scaled version of Mario 
scalex=1.3
row, col = my_video.get_sprite_loc("SuperMario")  
for moves in range(1,4,1):
    my_video.set_new_frame('back2', top_offset, left_offset) 
    my_video.scale_sprite("SuperMario", row + 10*moves, col,scalex)
