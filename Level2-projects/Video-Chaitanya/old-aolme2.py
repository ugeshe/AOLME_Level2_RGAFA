...
def img_im_fill(img, rows, cols, color):
    """
...
class spr:
    ...
    def set_sprite(self, sprite_name):
        ...
        self.sprite_img = SpriteInfo[1]
            
        # Variable obj_roi is the mask (0 or 255) generated with roipoly library
        self.sprite_roi = SpriteInfo[2]
        
        # Corners values of the Rectangular ROI around the sprite
        self.sprite_rec = SpriteInfo[3]
        
        # Size also:
        self.num_of_rows, self.num_of_cols, col = self.sprite_img.shape 
