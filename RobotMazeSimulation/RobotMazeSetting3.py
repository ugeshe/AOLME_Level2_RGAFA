...
class RobotMazeSetting:
    ...
    def ltd(self, angle):
        ...
        # h, w = self.sprite.image.get_rect().size[0], self.sprite.image.get_rect().size[1]
        # print(h, w)
        # x, y = self.sprite.rect.center
        # if (self.angle>=0 and self.angle<=90):
        #     new_h = 32*math.cos(self.angle/180*math.pi)+32*math.sin(self.angle/180*math.pi)
        #     new_w = 32*math.cos(self.angle/180*math.pi)+32*math.sin(self.angle/180*math.pi)
        
        # self.sprite.image = pygame.Surface.subsurface(self.sprite.image, (y-new_h/2,
        #                                                                   x-new_w/2,
        #                                                                   new_h, new_w))
...
#         if h>45:
#             
#             self.sprite.image = pygame.Surface.subsurface(self.sprite.image, (h/2-22,
#                                                                            w/2-22,
#                                                                            44,44))
#             #h =44
#             #w =44
